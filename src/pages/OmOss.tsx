    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-rehab-gray-100 pt-24 pb-10">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-rehab-black mb-4">Om oss</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="mb-16">
            <h2 className="text-2xl font-bold text-rehab-black mb-6">Vår historia</h2>
          ...
          <div className="mb-16">
            <h2 className="text-2xl font-bold text-rehab-black mb-6">Vårt team</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-rehab-gray-100 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-rehab-black mb-2">Petra Nässelqvist</h3>
                <p className="text-rehab-gray-700 font-medium mb-2">Fysioterapeut</p>
                <p className="text-rehab-gray-600">
              ...
              <div className="bg-rehab-gray-100 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-rehab-black mb-2">Linda Eng-Eriksson</h3>
                <p className="text-rehab-gray-700 font-medium mb-2">Fysioterapeut</p>
                <p className="text-rehab-gray-600">
              ...
              <div className="bg-rehab-gray-100 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-rehab-black mb-2">Eva Helde</h3>
                <p className="text-rehab-gray-700 font-medium mb-2">Läkare</p>
                <p className="text-rehab-gray-600">
          ...
          <div>
            <h2 className="text-2xl font-bold text-rehab-black mb-6">Vår filosofi</h2>
            <p className="text-rehab-gray-600 mb-4">
